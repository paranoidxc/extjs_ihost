...
Ext.define('Ext.ux.form.plugin.HtmlEditor', {
    ...
    */
    ...
    onInitialize: function(){
		...
		*/
        if(me.enableImages|| me.enableAll){
    ...
    doImages: function() {
      if( Ext.getCmp('img-chooser-dlg') != null ) {
        Ext.getCmp('img-chooser-dlg').show();
        return ;
      }

      this.photoWindow = Ext.create('Ext.chooser.Window', {
        id: 'img-chooser-dlg',
        maximizable: true, 
          ...
          selected: function(image){       
            ...
            */            
            ...
            if(this.editor.getValue() == null || this.editor.getValue() == ""){
              this.editor.setValue('fuck');
            }else{
              this.editor.focus();
              this.editor.insertAtCursor('xiao');
            }         
          },
          scope: this
        }
